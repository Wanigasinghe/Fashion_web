<?php
    ...
    $insert_product->execute([$id, $seller_id, $name, $price, $category, $thumb_one, $thumb_two, $thumb_three, $stock, 
        $content, $status]);
            ...
            <form action="" method="post" enctype="multipart/form-data" class="register">
                <div class="flex">
                 ...
                 <div class="input-field">
                    ...
                    <textarea class="box" name="content" required placeholder="Enter product description"></textarea>
                 </div>
                 <div class="flex-btn">
