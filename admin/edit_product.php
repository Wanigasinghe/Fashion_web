<?php
   ...
   $update_product = $conn->prepare("UPDATE `products` 
   SET name = ?, price = ?, category = ?, product_detail = ?, stock = ?, status = ? 
   WHERE id = ?");
  ...
  $update_image = $conn->prepare("UPDATE `products` 
   SET thumb_one = ?, thumb_two = ?, thumb_three = ? 
   WHERE id = ?");
...
<body>
    ...
    <div class="edit_products">
                ...
                <div class="flex">
                    <div class="col">
                        <div class="input-field">
                            ...
                            <input type="text" name="name" maxlength="100" value="<?= $fetch_product['name']; ?>" 
                             class="box">
                        </div>
                        <div class="input-field">
                        ...
                        <div class="input-field">
                            ...
                            <select name="category"  class="box">
                                <option selected value="<?= $fetch_product['category']; ?>"><? $fetch_product
                                ['category']; ?></option>
                     ...
                     <div class="col">
                        ...
                        <div class="input-field">
                            ...
                            <select name="status"  class="box">
                                <option selected value="<?= $fetch_product['status']; ?>"><? $fetch_product
                                ['status']; ?></option>
        ...
        <div class="input-field">
            <div class="flex-btn">
                <img src="../uploaded_files/<?= $fetch_product['thumb_one']; ?>" width=300px>
                <img src="../uploaded_files/<?= $fetch_product['thumb_two']; ?>" width=300px>
                <img src="../uploaded_files/<?= $fetch_product['thumb_three']; ?>" width=300px>
            </div>
        </div>
                 
                 <div class="flex-btn">
                     <button type="submit" name="updated" class="btn">update product</button>
